<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my-skills.aspx.cs" Inherits="MentorHub.Mentor.Mentor_My_Skills" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>My Skills | MentorHub</title>
  ...
  <body class="mentor-shell" data-page="skills">
    <div class="d-flex">
      <aside class="sidebar mp-sidebar">
        ...
        <nav class="mp-nav nav flex-column">
          ...
          <a class="nav-link active" href="my-skills.aspx"><i class="bi bi-lightbulb"></i><span>My Skills</span></a>
      ...
      <main class="flex-grow-1 content-area p-4">
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4 fade-in">
          <div>
            <span class="mp-page-eyebrow"><i class="bi bi-lightbulb"></i>My Skills</span>
            <h2 class="fw-bold mt-3 mb-1">Core expertise and learning focus areas</h2>
            <p class="text-muted mb-0">Showcase the capabilities your mentees can rely on for practical guidance and growth.</p>
          </div>
          <a href="edit-skills.aspx" class="mp-btn mp-btn-primary"><i class="bi bi-pencil"></i>Edit Skills</a>
        </div>

        <div class="row g-4 mp-stagger" data-skills-list>
          <!-- populated by mentor-app.js -->
        </div>
