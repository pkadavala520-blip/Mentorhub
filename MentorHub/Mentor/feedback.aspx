<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="MentorHub.Mentor.Mentor_Feedback" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Feedback | MentorHub</title>
  ...
  <body class="mentor-shell" data-page="feedback">
    <div class="d-flex">
      <aside class="sidebar mp-sidebar">
        ...
        <nav class="mp-nav nav flex-column">
          ...
          <a class="nav-link active" href="feedback.aspx"><i class="bi bi-star"></i><span>Feedback</span></a>
      ...
      <main class="flex-grow-1 content-area p-4">
        ...
        <div class="mb-4 fade-in">
          <span class="mp-page-eyebrow"><i class="bi bi-star"></i>Feedback</span>
          <h2 class="fw-bold mt-3 mb-1">What your mentees are saying</h2>
        </div>

        <div class="row g-4">
          <div class="col-lg-4 fade-in">
            <div class="mp-card p-4 text-center h-100 d-flex flex-column justify-content-center">
              <div class="display-5 fw-bold text-primary" data-profile-rating>4.9</div>
              <div class="mp-stars mb-2"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
              <p class="text-muted small mb-3">Based on <span data-profile-reviews>128</span> reviews</p>
              <div data-rating-bars></div>
            </div>
          </div>
          <div class="col-lg-8 fade-in">
            <div class="mp-card p-4 h-100">
              <h5 class="fw-semibold mb-2">Recent Reviews</h5>
