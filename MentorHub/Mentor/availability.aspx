<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="availability.aspx.cs" Inherits="MentorHub.Mentor.Mentor_Availability" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Availability | MentorHub</title>
  ...
  <body class="mentor-shell" data-page="availability">
    <div class="d-flex">
      ...
      <main class="flex-grow-1 content-area p-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 fade-in">
          <div>
            <span class="mp-page-eyebrow"><i class="bi bi-calendar2-week"></i>Availability</span>
            <h2 class="fw-bold mt-3 mb-1">Weekly availability calendar</h2>
            <p class="text-muted mb-0">Let mentees know exactly when you're free to connect.</p>
          </div>
          <a href="add-slot.aspx" class="mp-btn mp-btn-primary"><i class="bi bi-plus-lg"></i>Add Slot</a>
        </div>

        <div class="mp-card p-4 fade-in">
          <h5 class="fw-semibold mb-3">Weekly Schedule</h5>
          <div class="mp-week-grid" data-availability-grid></div>
        </div>
