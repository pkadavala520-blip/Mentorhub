<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mentees.aspx.cs" Inherits="MentorHub.Mentor.Mentor_Mentees" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>My Mentees | MentorHub</title>
  ...
  <body class="mentor-shell" data-page="mentees">
    <div class="d-flex">
      ...
      <main class="flex-grow-1 content-area p-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 fade-in">
          <div>
            <span class="mp-page-eyebrow"><i class="bi bi-people"></i>My Mentees</span>
            <h2 class="fw-bold mt-3 mb-1">Your mentoring relationships</h2>
            <p class="text-muted mb-0">Track progress and jump back into any conversation.</p>
          </div>
          <div class="mp-search">
            <i class="bi bi-search"></i>
            <input type="text" placeholder="Search mentees…" data-mentee-search />
          </div>
        </div>

        <div class="row g-4 mp-stagger" data-mentee-grid></div>
