<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit-skills.aspx.cs" Inherits="MentorHub.Mentor.Mentor_Edit_Skills" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Edit Skills | MentorHub</title>
  ...
  <body class="mentor-shell" data-page="edit-skills">
    <div class="d-flex">
      ...
      <main class="flex-grow-1 content-area p-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 fade-in">
          <div>
            <span class="mp-page-eyebrow"><i class="bi bi-pencil"></i>Edit Skills</span>
            <h2 class="fw-bold mt-3 mb-1">Keep your expertise up to date</h2>
          </div>
          <a href="my-skills.aspx" class="mp-btn mp-btn-outline"><i class="bi bi-arrow-left"></i>Back</a>
        </div>

        <div class="mp-card p-4 fade-in" style="max-width:760px;">
          <h5 class="fw-semibold mb-3">Update Expertise</h5>
          <form class="row g-3" data-edit-skills-form></form>
        </div>
