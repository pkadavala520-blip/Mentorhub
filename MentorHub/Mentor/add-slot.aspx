<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-slot.aspx.cs" Inherits="MentorHub.Mentor.Mentor_Add_Slot" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Add Slot | MentorHub</title>
  ...
  <body class="mentor-shell" data-page="add-slot">
    <div class="d-flex">
      <aside class="sidebar mp-sidebar">
        ...
        <nav class="mp-nav nav flex-column">
          ...
          <a class="nav-link active" href="availability.aspx"><i class="bi bi-calendar2-week"></i><span>Availability</span></a>
      ...
      <main class="flex-grow-1 content-area p-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 fade-in">
          <div>
            <span class="mp-page-eyebrow"><i class="bi bi-plus-lg"></i>Add Slot</span>
            <h2 class="fw-bold mt-3 mb-1">Create a new availability slot</h2>
          </div>
          <a href="availability.aspx" class="mp-btn mp-btn-outline"><i class="bi bi-arrow-left"></i>Back</a>
        </div>

        <div class="mp-card p-4 fade-in" style="max-width:560px;">
          <h5 class="fw-semibold mb-3">New Availability Slot</h5>
          <form class="row g-3" data-add-slot-form>
            <div class="col-md-6">
            ...
            <div class="col-md-3"><label class="form-label">Start Time</label><input type="time" class="form-control" name="start" value="19:00" /></div>
            <div class="col-md-3"><label class="form-label">End Time</label><input type="time" class="form-control" name="end" value="21:00" /></div>
            <div class="col-12"><button type="submit" class="mp-btn mp-btn-primary"><i class="bi bi-check2-circle"></i>Add Slot</button></div>
          </form>
        </div>
